...
export const metadata: Metadata = {
  title: 'Good News Mission - Testimonies',
  description: 'Experience the impact of the Gospel through personal testimonies',
};
...
export default function TestimoniesLayout({
  ...
  <p className="text-lg md:text-xl text-gray-600 mb-4">
    Experience the impact of the Gospel through personal testimonies
  </p>
