    ...
    return (
        <div className="p-6 md:p-8">
            ...
            <section className="mb-10">
                ...
                <div className="mb-8">
                    ...
                    <div className="space-y-4 text-gray-700 leading-relaxed">
                        ...
                        <p>
                            The Gospel According to Matthew is the first book of the New Testament of the Bible and one of the three synoptic gospels. It tells how Israel's Messiah, rejected and executed in Israel, pronounces judgment on Israel and its leaders and becomes the Salvation of the gentiles.
                        </p>
                        <p>
                            The Gospel of Matthew is especially important for it is one of the two Gospels originally written by an apostle of Jesus about 80-90 AD. The Gospel of Matthew was possibly written in Antioch an early home of Christianity.
                        </p>
                        <p>
            ...
            <section className="mb-6">
                <h1 className="text-3xl font-bold text-[#0477BF] mb-6">Diploma 2</h1>
